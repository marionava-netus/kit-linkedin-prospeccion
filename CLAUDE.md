...
## Skills
- **`linkedin-nurture`** — la estrategia completa: escalera de conversación, framework RECON, anti-baneo, curación, estado. Es la skill principal.
...
- **Nunca vender en el mensaje** (framework RECON, `references/recon-framework.md`). El objetivo es la siguiente conversación.
